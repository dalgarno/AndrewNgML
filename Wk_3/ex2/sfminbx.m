function [x,FVAL,LAMBDA,EXITFLAG,OUTPUT,GRAD,HESSIAN] = sfminbx(funfcn,x,l,u,verb,options,defaultopt,...
    computeLambda,initialf,initialGRAD,initialHESS,Hstr,detailedExitMsg,varargin)
...
%   $Revision: 1.1.6.10 $  $Date: 2009/11/05 17:01:04 $
...
if DerivativeCheck
    ...
    [gf,unused1,unused2,numEvals]=finitedifferences(xcurr,funfcn{3},[],l,u,initialf,[],...
        [],1:numberOfVariables,true,finDiffOpts,sizes,gf,[],[],[],[],varargin{:});
    %
